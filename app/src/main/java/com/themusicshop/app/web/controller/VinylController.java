...
import com.themusicshop.app.web.service.DiscountConsumer;
...
public class VinylController {
    ...
    private final DiscountConsumer discountConsumer;

    @Autowired
    public VinylController(ModelMapper modelMapper, VinylService vinylService, DiscountConsumer discountConsumer) {
